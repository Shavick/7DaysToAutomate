public class BoilerBlock : MachineBlock<TileEntityBoiler>
{
    protected override TileEntityBoiler CreateTileEntity(Chunk chunk)
    {
        return new TileEntityBoiler(chunk);
    }
        ...
        BlockValue blockValue)
    {
        ...
        TileEntityBoiler te = world.GetTileEntity(clrIdx, blockPos) as TileEntityBoiler;
        if (te == null)
            return;
        ...
        EntityPlayerLocal player)
    {
        ...
        Helper.RequestMachineUIOpen(clrIdx, blockPos, player.entityId, "BoilerInfo");
        return true;
    }
