...
public class XUiC_GrinderInputContainerEntry : XUiController
{
    ...
    public XUiC_GrinderInputContainerList InputList;
    ...
    public void SetContainer(TileEntityComposite te, Vector3i pos, Guid pipeGraphId)
    {
        ContainerTE = te;
        ContainerPos = pos;
    ...
    private static string GetDisplayName(TileEntityComposite te)
    {
        ...
        TEFeatureSignable sign = te.GetFeature<TEFeatureSignable>();
